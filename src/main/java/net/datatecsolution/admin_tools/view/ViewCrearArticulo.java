...
import net.datatecsolution.admin_tools.controlador.CtlArticulo;
...
import net.datatecsolution.admin_tools.view.rendes.RtPrecios;
import net.datatecsolution.admin_tools.view.tablemodel.ComboBoxImpuesto;
import net.datatecsolution.admin_tools.view.tablemodel.ListaModeloCodBarra;
import net.datatecsolution.admin_tools.view.tablemodel.TmInsumo;
import net.datatecsolution.admin_tools.view.tablemodel.TmPrecios;
...
public class ViewCrearArticulo extends JDialog {
	...
	private JRadioButton rdbtnUnidad;
	...
	public ViewCrearArticulo(ViewListaArticulo view) {
		...
		super(view,"Agregar Articulos", ModalityType.DOCUMENT_MODAL);
		...
		btnCancelar.setBounds(333, 629, 136, 64);
		...
		JLabel lblNewLabel = new JLabel("Se vende por?");
		lblNewLabel.setBounds(10, 493, 127, 16);
		panel.add(lblNewLabel);

		rdbtnUnidad = new JRadioButton("Unidades");
		rdbtnUnidad.setSelected(true);
		rdbtnUnidad.setBounds(20, 509, 141, 23);
		grupoOpciones.add(rdbtnUnidad);
		panel.add(rdbtnUnidad);

		rdbtnLibras = new JRadioButton("Libras");
		rdbtnLibras.setBounds(148, 509, 141, 23);
		grupoOpciones.add(rdbtnLibras);
	...
	public JRadioButton getRdbtnUnidad() {
		return rdbtnUnidad;
	}

	public void setRdbtnUnidad(JRadioButton rdbtnUnidad) {
		this.rdbtnUnidad = rdbtnUnidad;
	}

	public JRadioButton getRdbtnLibras() {
		return rdbtnLibras;
	}

	public void setRdbtnLibras(JRadioButton rdbtnLibras) {
		this.rdbtnLibras = rdbtnLibras;
	}
}
