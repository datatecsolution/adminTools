...
public abstract class AbstractJasperReports implements Runnable {
	...
	private static InputStream devolucionCompra = null;
	...
	private static JasperReport reportDevolucionCompra;
	...
	public static void loadFileReport() {
		...
		facturaTiketCredito = AbstractJasperReports.class.getResourceAsStream("/reportes/factura_ticket_fit_credito.jasper");
		...
		facturaCompra = AbstractJasperReports.class.getResourceAsStream("/reportes/factura_compra_carta.jasper");
		facturaReimpresion = AbstractJasperReports.class.getResourceAsStream("/reportes/factura_ticket_fit.jasper");
		...
		existenciaBodegaCategoria = AbstractJasperReports.class
				.getResourceAsStream("/reportes/ReporteExistenciaBodegaCategoria.jasper");
		...
		ventasCategoriaTotal = AbstractJasperReports.class
				.getResourceAsStream("/reportes/ventas_categoria_total.jasper");

		cierreVentasDetalleCateg = AbstractJasperReports.class
				.getResourceAsStream("/reportes/cierre_ventas_detalle_categ.jasper");
		...
		devolucionCompra = AbstractJasperReports.class.getResourceAsStream("/reportes/devoluciones_compra.jasper");
		...
		try {
			...
			reportDevolucionCompra = (JasperReport) JRLoader.loadObject(devolucionCompra);
	...
	public static void createReportVentasUsuarios(Connection conn, Date fechaMin, Date fechaMax,
			List<Comision> comisiones, int porcentaje) {
	...
	public static void createReportVentasArticulo(Connection conn, List<DetalleFactura> ventas, Articulo articulo,
	...
	public static void createReportRuta(Connection conn, RutaEntrega ruta, List<DetalleFactura> ventas,
		...
		Map<String, Object> parametros = new HashMap<String, Object>();
		parametros.put("fecha", ruta.getFecha());
		parametros.put("usuario", ConexionStatic.getUsuarioLogin().getUser());

		parametros.put("vendedor", ruta.getVendedor().getCodigo() + " | " + ruta.getVendedor().getNombre() + " "
				+ ruta.getVendedor().getApellido());
	...
	public static void createReportVentasDetalleTurno(Connection conn, CierreCaja cierre, List<DetalleFactura> ventas,
			Caja myCaja) {
	...
	public static void createRepCierreVentasDetallesCateg(Connection conn, CierreCaja cierre,
			List<DetalleFactura> ventas, Categoria myCategoria) {
	...
	public static void createReportComisiones(Connection conn, Date fechaMin, Date fechaMax, List<Comision> comisiones,
			int porcentaje) {
	...
	public static void createReportSarVentas(Connection conn, int mes, int anio, String usuario,
			String bD_facturacion) {
	...
	public static void createReportArticulosPreios(Connection conn, String user, Integer codigoCategoria) {
		Map parametros = new HashMap();
		parametros.put("usuario", user);
	...
	public static void createReportInventarioBodegaCategoria(Connection conn, String user, Integer idBodega,
			Integer idCategoria) {
		Map parametros = new HashMap();
		parametros.put("usuario", user);
		parametros.put("codigo_bodega", idBodega);
	...
	public static void createReportFacturaCartaCredito(Connection conn, Integer idFactura, String obrs) {
	...
	public static void Imprimir2() {
		...
		try {
			...
			AttributeSet attributeSet = new HashPrintServiceAttributeSet(
					new PrinterName("\\\\TEXACOADMIN\\EPSON L210 Series", null));

			// AttributeSet attributeSet = new HashPrintServiceAttributeSet(new
			// PrinterName("\\\\CONTABILIDAD-PC\\EPSON LX-300+ /II (Copiar 1)", null));
	...
	public static void createReportDevolucionCompra(Connection conn, Integer idFactura) {
		Map parametros = new HashMap();
		parametros.put("numero_factura", idFactura);
		if (ConexionStatic.getUsuarioLogin().getCajaActiva() != null) {
			parametros.put("bD_facturacion", ConexionStatic.getUsuarioLogin().getCajaActiva().getNombreBd());
