...
public abstract class ModeloDaoBasic {
	...
	protected static final String dbNameCaja="admin_tools_caja_";
	protected static final String DbNameBase="admin_tools";
	protected  String DbName="admin_tools";
